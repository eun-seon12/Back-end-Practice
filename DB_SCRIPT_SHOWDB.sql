...
(
	`USER_ID`    INTEGER(3) AUTO_INCREMENT NOT NULL COMMENT '회원id',
    `USER_NAME`    VARCHAR(20) NOT NULL COMMENT '회원명',
    `USER_PWD`    VARCHAR(15) NOT NULL COMMENT '회원비밀번호',
    `AGE`    INTEGER(3) COMMENT '회원나이',
    `PHONE`    VARCHAR(12) UNIQUE COMMENT '회원전화번호',
    `GENDER`    VARCHAR(3) COMMENT '회원성별',
 PRIMARY KEY ( `USER_ID` )
) AUTO_INCREMENT= 101 COMMENT = '회원';

INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('김하나','first',20,'01012345678','F');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('강둘','second',15,'01012348765','F');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('나셋','third',25,'01056781234','M');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('박넷','fourth',50,'01056784321','M');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('이다섯','fifth',42,'01043215678','F');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('이여섯','sixth',28,'01043218765','M');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('장일곱','seventh',35,'01012340005','M');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('최여덟','eighth',30,'01012340006','F');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('표아홉','nineth',45,'01012340007','F');
INSERT INTO user (USER_NAME, USER_PWD, AGE, PHONE, GENDER) VALUES ('홍열','tenth',4,'01012340008','F');
...
(
 ...
 FOREIGN KEY ( `SHOW_ID` ) REFERENCES musical ( `SHOW_ID` )
 
) COMMENT = '예매';

INSERT INTO reservation VALUES (1111,70000,'Y',101,1000);
INSERT INTO reservation VALUES (2222,100000,'Y',102,1000);
INSERT INTO reservation VALUES (3333,130000,'Y',107,1004);
INSERT INTO reservation VALUES (4444,150000,'Y',105,1003);
...
(
    ...
    `SEAT_YN`    VARCHAR(1) CHECK (`SEAT_YN` IN ('Y', 'N')) DEFAULT 'Y' NOT NULL COMMENT '좌석여부',
